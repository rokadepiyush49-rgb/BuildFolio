...
export default function HomeCommonFooter() {
    return (
        <>
            ...
            <div className="footer-section">
                ...
                <div className="footer-links">
                    ...
                    <Link to="/about-us" className="footer-link" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
                        About Us
                    </Link>
                    <Link to="/login-signup" className="footer-link">
                        Login / Sign Up
                    </Link>
                </div>
            </div>
